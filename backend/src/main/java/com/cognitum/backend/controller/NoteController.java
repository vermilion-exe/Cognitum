...
public class NoteController {
    ...
    @GetMapping("/since")
    public List<ResponseNote> getNotesSince(@RequestHeader("Authorization") String token, @RequestParam @DateTimeFormat(iso = DateTimeFormat.ISO.DATE_TIME) OffsetDateTime timestamp) {
